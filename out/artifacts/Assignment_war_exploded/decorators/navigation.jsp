<nav class="d-flex align-items-center"><a href="https://www.lamborghini.com/en-en" class="logo align-self-start"><img
    ...
    <div class="d-flex right align-items-center">
        ...
        <button type="button" aria-expanded="false" data-toggle="overlay" data-target="#overlay-search">
            <svg xmlns="http://www.w3.org/2000/svg" width="17.283" height="18.023" viewBox="0 0 17.283 18.023">
                <g transform="translate(-1463.392 -389.942)">
                    ...
                    <rect width="0.944" height="7.181" transform="translate(1475.069 402.736) rotate(-43.24)"/>
                </g>
            </svg>
        </button>
        ...
        <button type="button" class="hamburger d-block d-md-none" aria-expanded="false" data-toggle="overlay"
                data-target="#overlay-burger-mobile">
            <div></div>
            <div></div>
            <div></div>
        </button>
